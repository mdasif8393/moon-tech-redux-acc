  ...
  return (
    ...
    >
      ...
      {pathname.includes("cart") && (
        <button className='bg-red-500 flex justify-between items-center px-2 rounded-full py-1 flex-1 text-white text-bold'
        onClick={()=>dispatch(removeFromCart(product))}
        >
          <p>Remove</p>
          <RiDeleteBin2Line size={20}></RiDeleteBin2Line>
        </button>)}
